...
// atvaizduot documente visu todu, kurie yra completed, title'us

var completedTrue = [];
var completedFalse = [];

for (var i = 0; i < todos.length; i++) {
  var konkretus = todos[i];
  if (konkretus.completed == true) {
    completedTrue.push(konkretus);
  }
  if (konkretus.completed == false) {
    completedFalse.push(konkretus);
  }
}
...
for (var manoNorimasParametras of completedTrue) {
  console.log("true:", manoNorimasParametras.title);
}

for (var manoNorimasParametras of completedFalse) {
  console.log("false:", manoNorimasParametras.title);
}
